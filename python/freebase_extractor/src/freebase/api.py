...
def create_queries_for_entity(
    ...
    and the language code to use for the query.
    """
...
def execute_freebase_queries(queries):
    ...
    function. Returns a list of tuples created by decoding the returned
    JSON and processing the results.
    """
    tuple_list = []
...
def create_turtle_download_link(rdf_service_url, api_key, topic_id):
    """Creates a Turtle download link for the specified topic ID."""
