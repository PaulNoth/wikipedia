...
def article_categories_sk
  ...
  file_path = "sample_input/sample_article_categories_sk_nemecko.ttl"
...
def article_templates_sk
  hash = Hash.new([])
    ...
    file_path = "sample_input/sample_article_templates_sk_nemecko.ttl"
...
def external_links_sk
  hash = Hash.new([])
    ...
    file_path = "sample_input/sample_external_links_sk_nemecko.ttl"
...
def freebase_links_sk
  hash = Hash.new([])
    ...
    file_path = "sample_input/sample_freebase_links_sk_nemecko.ttl"
...
def long_abstracts_sk
  hash = Hash.new([])
    ...
    file_path = "sample_input/sample_long_abstracts_sk_nemecko.ttl"
...
def interlanguage_links_sk
  hash = Hash.new([])
    ...
    file_path = "sample_input/sample_interlanguage_links_sk_nemecko.ttl"
...
def wikipedia_links_sk
  hash = Hash.new([])
    ...
    file_path = "sample_input/sample_wikipedia_links_sk_nemecko.ttl"
