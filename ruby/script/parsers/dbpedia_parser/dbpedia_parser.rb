...
def article_categories_sk
  ...
  if sample_input
    file_path = "sample_input/sample_article_categories_sk.ttl"
  else
...
def article_templates_sk
  ...
  if sample_input
    file_path = "sample_input/sample_article_templates_sk.ttl"
  else
...
def external_links_sk
  ...
  if sample_input
    file_path = "sample_input/sample_external_links_sk.ttl"
  else
...
def freebase_links_sk
  ...
  if sample_input
    file_path = "sample_input/sample_freebase_links_sk.ttl"
  else
...
def long_abstracts_sk
  ...
  if sample_input
    file_path = "sample_input/sample_long_abstracts_sk.ttl"
  else
...
def interlanguage_links_sk
  ...
  if sample_input
    file_path = "sample_input/sample_interlanguage_links_sk.ttl"
  else
...
def wikipedia_links_sk
  ...
  if sample_input
    file_path = "sample_input/sample_wikipedia_links_sk.ttl"
  else
