...
public class MyFilePaths{
    ...
    public static final String SAMPLE_TREE_FILE = DATALOCATION  + "sample" + File.separator +"sample_treeFile.xml";
    public static final String FULL_SK_TREE_FILE = DATALOCATION + "sk" + File.separator + "full_sk_treeFile.xml";
    public static final String FULL_CZ_TREE_FILE = DATALOCATION + "cz" + File.separator + "full_cz_treeFile.xml";
