...
/**
 * The Class RootChangeTest.
 */
public class RootChangeTest {
	...
	@Test
	public void test() {
		String testFile = "../data/skwiki_test_rootChanges_sample.txt";
		Main m = new Main();
		...
		String outputData = st.rootChangeHashMapToString(hmRootChange);
